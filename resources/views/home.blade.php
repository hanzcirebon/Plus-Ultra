...
<body>
    ...
    <div class="card" style="border-color: var(--bs-body-bg);">
            ...
            <div class="container py-4 py-xl-5" data-aos="slide-up" data-aos-duration="700" style="padding-left: 16px;padding-right: 35px;border-left-color: #ededee;">
                <div class="row mb-5">
                    <div class="col-md-8 col-xl-6 text-center mx-auto">
                        ...
                        <p data-bss-hover-animate="pulse" class="w-lg-50"><span style="text-decoration: underline; color: rgb(124, 118, 187);">See All Courses&nbsp;</span></p>
                    </div>
                </div>
                <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3">
                    <div class="col">
                        <div class="d-flex p-3" data-bss-hover-animate="pulse" style="margin-bottom: 7px;">
                    ...
                    <div class="col">
                        <div class="d-flex p-3" data-bss-hover-animate="pulse" style="border-style: solid;border-color: rgb(237,237,238);margin-bottom: -1px;margin-top: -1px;">
                            ...
                            <div class="px-2">
                                <h5 class="mb-0 mt-1"><span style="color: rgb(124, 118, 187);">Cybersecurity</span></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="d-flex p-3" data-bss-hover-animate="pulse" style="color: rgb(0,0,0);border-style: solid;border-color: rgb(237,237,238);border-left-color: rgb(237,237,238);">
                            ...
                            <div class="px-2">
                                <h5 class="mb-0 mt-1"><span style="color: rgb(124, 118, 187);">UI/UX Design</span></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="d-flex p-3" data-bss-hover-animate="pulse" style="margin-top: 4px;">
                            ...
                            <div class="px-2">
                                <h5 class="mb-0 mt-1"><span style="color: rgb(124, 118, 187);">Operations</span></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="d-flex p-3" data-bss-hover-animate="pulse" style="border-style: solid;border-color: rgb(237,237,238);border-top-color: rgb(33,;border-right-color: 37,;border-bottom-color: 41);border-left-color: 37,;">
                            ...
                            <div class="px-2">
                                <h5 class="mb-0 mt-1"><span style="color: rgb(124, 118, 187);">Development</span></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-4 offset-xxl-0" style="border: 2px inherit var(--bs-body-color) ;">
                        <div class="d-flex p-3" data-bss-hover-animate="pulse" style="border-style: solid;border-color: rgb(237,237,238);">
                            ...
                            <div class="px-2">
                                <h5 class="mb-0 mt-1"><span style="color: rgb(124, 118, 187);">Data Science</span></h5>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container py-4 py-xl-5" data-aos="slide-up" data-aos-duration="700">
                <div class="row gy-4 gy-md-0">
                    <div class="col-md-6 text-center text-md-start d-flex d-sm-flex d-md-flex justify-content-center align-items-center justify-content-md-start align-items-md-center justify-content-xl-center">
                        <div style="max-width: 350px;">
                            <h2 class="text-uppercase fw-bold"><span style="color: rgb(124, 118, 187);">We help you to discover your path in IT</span></h2>
                            <p class="my-3">we guide you through the vast landscape of IT and digital creation courses. Whether you’re just starting or looking to specialize, we have something for everyone.</p><a class="btn btn-primary btn-lg me-2" role="button" data-bss-hover-animate="pulse" href="#">Know More</a>
                        </div>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="container py-4 py-xl-5" data-aos="fade" data-aos-duration="700">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2><span style="color: rgb(124, 118, 187);">Our Main Services</span></h2>
            ...
            <section class="py-4 py-xl-5">
                <div class="container">
                    <div class="text-center p-4 p-lg-5" data-aos="slide-up" data-aos-duration="700">
                        <h1 class="fw-bold mb-4"><span style="color: rgb(124, 118, 187);">About Us</span></h1>
