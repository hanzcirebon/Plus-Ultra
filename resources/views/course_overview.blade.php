        ...
        <div class="px-2 py-5 min-w-xs max-w-xs w-full">
            <div id="accordion-collapse" data-accordion="collapse" class="">
                ...
                <h2 id="accordion-collapse-heading-2">
                    <button type="button" class="flex items-center justify-between w-full p-5 font-medium rtl:text-right border border-gray-200 focus:ring-4 focus:ring-gray-200 hover:bg-gray-100 gap-3 border-b-0" data-accordion-target="#accordion-collapse-body-2" aria-expanded="true" aria-controls="accordion-collapse-body-2">
