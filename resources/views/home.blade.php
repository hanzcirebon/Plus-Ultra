...
<body>
    ...
    <div class="card">
        <form><input class="form-control" type="search">
            <div class="container py-4 py-xl-5">
                <div class="row mb-5">
                    <div class="col-md-8 col-xl-6 text-center mx-auto">
                        <h2><span style="color: rgb(124, 118, 187);">Explore by Your Course/Interest</span></h2>
                        <p class="w-lg-50"><a><span style="color: rgb(124, 118, 187);">See all courses &rarr;</span></a></p>
                    </div>
                </div>
