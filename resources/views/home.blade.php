            ...
            <div class="container py-4 py-xl-5" data-aos="slide-up" data-aos-duration="700" style="padding-left: 16px;padding-right: 35px;border-left-color: #ededee;">
                <div class="row mb-5">
                    <div class="col-md-8 col-xl-6 text-center mx-auto">
                        ...
                        <p data-bss-hover-animate="pulse" class="w-lg-50"><span style="text-decoration: underline; color: rgb(124, 118, 187);">See All Courses &rarr;&nbsp;</span></p>
                    </div>
                </div>
                <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3">
                    <div class="col">
                        <div class="d-flex p-3" data-bss-hover-animate="pulse" style="margin-bottom: 4px;border-style: solid;border-color: rgb(237,237,238);margin-top: 4px;">
                    ...
                    <div class="col">
                        <div class="d-flex p-3" data-bss-hover-animate="pulse" style="border-style: solid;border-color: rgb(237,237,238);margin-bottom: 4px;margin-top: 4px;">
                    ...
                    <div class="col">
                        <div class="d-flex p-3" data-bss-hover-animate="pulse" style="color: rgb(0,0,0);border-style: solid;border-color: rgb(237,237,238);border-left-color: rgb(237,237,238);margin-bottom: 4px;margin-top: 4px;">
                    ...
                    <div class="col">
                        <div class="d-flex p-3" data-bss-hover-animate="pulse" style="margin-top: 4px;border-style: solid;border-color: rgb(237,237,238);margin-bottom: 4px;">
                    ...
                    <div class="col">
                        <div class="d-flex p-3" data-bss-hover-animate="pulse" style="border-style: solid;border-color: rgb(237,237,238);border-top-color: rgb(33,;border-right-color: 37,;border-bottom-color: 41);border-left-color: 37,;margin-bottom: 4px;margin-top: 4px;">
