    ...
    <div class="2xl pt-32 big-div">
        <div class="flex max-md:flex-col justify-center max-md:items-center gap-10 pb-32 explore-by-interest">
            ...
            <div class="grid grid-cols-3 gap-5 justify-between max-xl:grid-cols-2 max-lg:grid-cols-1 max-lg:gap-2">
                <a href="{{ route('career-choices.details', 'Information Technology') }}" class="flex flex-row border-2 border-gray-300 w-[288px] h-[56px] items-center ease-out duration-150 hover:shadow-[3px_3px_2px_2px] hover:shadow-gray-300 focus:border-light_purple_template focus:shadow-light_purple_template">
                ...
                <a href="{{ route('career-choices.details', 'Data Structures') }}" class="flex flex-row border-2 border-gray-300 w-[288px] h-[56px] items-center ease-out duration-150 hover:shadow-[3px_3px_2px_2px] hover:shadow-gray-300 focus:border-light_purple_template focus:shadow-light_purple_template">
                    <div class="text-white bg-purple_template p-2.5 rounded-full m-2.5">
                ...
                <a href="{{ route('career-choices.details', 'Decision Support Systems') }}" class="flex flex-row border-2 border-gray-300 w-[288px] h-[56px] items-center ease-out duration-150 hover:shadow-[3px_3px_2px_2px] hover:shadow-gray-300 focus:border-light_purple_template focus:shadow-light_purple_template">
                    <div class="text-white bg-purple_template p-2.5 rounded-full m-2.5">
                ...
                <a href="{{ route('career-choices.details', 'Computer Science') }}" class="flex flex-row border-2 border-gray-300 w-[288px] h-[56px] items-center ease-out duration-150 hover:shadow-[3px_3px_2px_2px] hover:shadow-gray-300 focus:border-light_purple_template focus:shadow-light_purple_template">
                    <div class="text-white bg-purple_template p-2.5 rounded-full m-2.5">
                ...
                <a href="{{ route('career-choices.details', 'Security Science') }}" class="flex flex-row border-2 border-gray-300 w-[288px] h-[56px] items-center ease-out duration-150 hover:shadow-[3px_3px_2px_2px] hover:shadow-gray-300 focus:border-light_purple_template focus:shadow-light_purple_template">
                    <div class="text-white bg-purple_template p-2.5 rounded-full m-2.5">
                ...
                <a href="{{ route('career-choices.details', 'Artificial Intelligence') }}" class="flex flex-row border-2 border-gray-300 w-[288px] h-[56px] items-center ease-out duration-150 hover:shadow-[3px_3px_2px_2px] hover:shadow-gray-300 focus:border-light_purple_template focus:shadow-light_purple_template">
                    <div class="text-white bg-purple_template p-2.5 rounded-full m-2.5">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-stack">
                            <path d="m14.12 10.163 1.715.858c.22.11.22.424 0 .534L8.267 15.34a.598.598 0 0 1-.534 0L.165 11.555a.299.299 0 0 1 0-.534l1.716-.858 5.317 2.659c.505.252 1.1.252 1.604 0l5.317-2.66zM7.733.063a.598.598 0 0 1 .534 0l7.568 3.784a.3.3 0 0 1 0 .535L8.267 8.165a.598.598 0 0 1-.534 0L.165 4.382a.299.299 0 0 1 0-.535L7.733.063z"></path>
                            <path d="m14.12 6.576 1.715.858c.22.11.22.424 0 .534l-7.568 3.784a.598.598 0 0 1-.534 0L.165 7.968a.299.299 0 0 1 0-.534l1.716-.858 5.317 2.659c.505.252 1.1.252 1.604 0l5.317-2.659z"></path>
                ...
                <a href="{{ route('career-choices.details', 'Computer Graphics') }}" class="flex flex-row border-2 border-gray-300 w-[288px] h-[56px] items-center ease-out duration-150 hover:shadow-[3px_3px_2px_2px] hover:shadow-gray-300 focus:border-light_purple_template focus:shadow-light_purple_template">
                    <div class="text-white bg-purple_template p-2.5 rounded-full m-2.5">
                ...
                <a href="{{ route('career-choices.details', 'Database Management') }}" class="flex flex-row border-2 border-gray-300 w-[288px] h-[56px] items-center ease-out duration-150 hover:shadow-[3px_3px_2px_2px] hover:shadow-gray-300 focus:border-light_purple_template focus:shadow-light_purple_template">
                    <div class="text-white bg-purple_template p-2.5 rounded-full m-2.5">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-stack">
                            <path d="m14.12 10.163 1.715.858c.22.11.22.424 0 .534L8.267 15.34a.598.598 0 0 1-.534 0L.165 11.555a.299.299 0 0 1 0-.534l1.716-.858 5.317 2.659c.505.252 1.1.252 1.604 0l5.317-2.66zM7.733.063a.598.598 0 0 1 .534 0l7.568 3.784a.3.3 0 0 1 0 .535L8.267 8.165a.598.598 0 0 1-.534 0L.165 4.382a.299.299 0 0 1 0-.535L7.733.063z"></path>
                            <path d="m14.12 6.576 1.715.858c.22.11.22.424 0 .534l-7.568 3.784a.598.598 0 0 1-.534 0L.165 7.968a.299.299 0 0 1 0-.534l1.716-.858 5.317 2.659c.505.252 1.1.252 1.604 0l5.317-2.659z"></path>
                ...
                <a href="{{ route('career-choices.details', 'Information Systems') }}" class="flex flex-row border-2 border-gray-300 w-[288px] h-[56px] items-center ease-out duration-150 hover:shadow-[3px_3px_2px_2px] hover:shadow-gray-300 focus:border-light_purple_template focus:shadow-light_purple_template">
                    <div class="text-white bg-purple_template p-2.5 rounded-full m-2.5">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-stack">
                            <path d="m14.12 10.163 1.715.858c.22.11.22.424 0 .534L8.267 15.34a.598.598 0 0 1-.534 0L.165 11.555a.299.299 0 0 1 0-.534l1.716-.858 5.317 2.659c.505.252 1.1.252 1.604 0l5.317-2.66zM7.733.063a.598.598 0 0 1 .534 0l7.568 3.784a.3.3 0 0 1 0 .535L8.267 8.165a.598.598 0 0 1-.534 0L.165 4.382a.299.299 0 0 1 0-.535L7.733.063z"></path>
                            <path d="m14.12 6.576 1.715.858c.22.11.22.424 0 .534l-7.568 3.784a.598.598 0 0 1-.534 0L.165 7.968a.299.299 0 0 1 0-.534l1.716-.858 5.317 2.659c.505.252 1.1.252 1.604 0l5.317-2.659z"></path>
                ...
                <a href="{{ route('career-choices.details', 'Systems Analysis and Design') }}" class="flex flex-row border-2 border-gray-300 w-[288px] h-[56px] items-center ease-out duration-150 hover:shadow-[3px_3px_2px_2px] hover:shadow-gray-300 focus:border-light_purple_template focus:shadow-light_purple_template">
                    <div class="text-white bg-purple_template p-2.5 rounded-full m-2.5">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-stack">
                            <path d="m14.12 10.163 1.715.858c.22.11.22.424 0 .534L8.267 15.34a.598.598 0 0 1-.534 0L.165 11.555a.299.299 0 0 1 0-.534l1.716-.858 5.317 2.659c.505.252 1.1.252 1.604 0l5.317-2.66zM7.733.063a.598.598 0 0 1 .534 0l7.568 3.784a.3.3 0 0 1 0 .535L8.267 8.165a.598.598 0 0 1-.534 0L.165 4.382a.299.299 0 0 1 0-.535L7.733.063z"></path>
                            <path d="m14.12 6.576 1.715.858c.22.11.22.424 0 .534l-7.568 3.784a.598.598 0 0 1-.534 0L.165 7.968a.299.299 0 0 1 0-.534l1.716-.858 5.317 2.659c.505.252 1.1.252 1.604 0l5.317-2.659z"></path>
                ...
                <a href="{{ route('career-choices.details', 'Programming') }}" class="flex flex-row border-2 border-gray-300 w-[288px] h-[56px] items-center ease-out duration-150 hover:shadow-[3px_3px_2px_2px] hover:shadow-gray-300 focus:border-light_purple_template focus:shadow-light_purple_template">
                    <div class="text-white bg-purple_template p-2.5 rounded-full m-2.5">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-stack">
                            <path d="m14.12 10.163 1.715.858c.22.11.22.424 0 .534L8.267 15.34a.598.598 0 0 1-.534 0L.165 11.555a.299.299 0 0 1 0-.534l1.716-.858 5.317 2.659c.505.252 1.1.252 1.604 0l5.317-2.66zM7.733.063a.598.598 0 0 1 .534 0l7.568 3.784a.3.3 0 0 1 0 .535L8.267 8.165a.598.598 0 0 1-.534 0L.165 4.382a.299.299 0 0 1 0-.535L7.733.063z"></path>
                            <path d="m14.12 6.576 1.715.858c.22.11.22.424 0 .534l-7.568 3.784a.598.598 0 0 1-.534 0L.165 7.968a.299.299 0 0 1 0-.534l1.716-.858 5.317 2.659c.505.252 1.1.252 1.604 0l5.317-2.659z"></path>
                ...
                <a href="{{ route('career-choices.details', 'Networks and Communications') }}" class="flex flex-row border-2 border-gray-300 w-[288px] h-[56px] items-center ease-out duration-150 hover:shadow-[3px_3px_2px_2px] hover:shadow-gray-300 focus:border-light_purple_template focus:shadow-light_purple_template">
                    <div class="text-white bg-purple_template p-2.5 rounded-full m-2.5">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-stack">
                            <path d="m14.12 10.163 1.715.858c.22.11.22.424 0 .534L8.267 15.34a.598.598 0 0 1-.534 0L.165 11.555a.299.299 0 0 1 0-.534l1.716-.858 5.317 2.659c.505.252 1.1.252 1.604 0l5.317-2.66zM7.733.063a.598.598 0 0 1 .534 0l7.568 3.784a.3.3 0 0 1 0 .535L8.267 8.165a.598.598 0 0 1-.534 0L.165 4.382a.299.299 0 0 1 0-.535L7.733.063z"></path>
                            <path d="m14.12 6.576 1.715.858c.22.11.22.424 0 .534l-7.568 3.784a.598.598 0 0 1-.534 0L.165 7.968a.299.299 0 0 1 0-.534l1.716-.858 5.317 2.659c.505.252 1.1.252 1.604 0l5.317-2.659z"></path>
